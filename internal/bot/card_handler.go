...
func (h *CardCallbackHandler) Handle(ctx context.Context, cardAction *larkcard.CardAction) (interface{}, error) {
	...
	default:
		log.Printf("未知的卡片 action: %s", actionStr)
		return nil, nil
	}
}
